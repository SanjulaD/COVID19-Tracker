const appSetToImage = document.getElementById('root');
...
// ----------------card Seven -------
    ...
    const cardImageDiv7 = document.createElement('div');
    cardImageDiv7.setAttribute('class' , 'card');
    const cardHeader7 = document.createElement('div');
    cardHeader7.setAttribute('class' , 'card-header');
    const cardHeaderText7 = document.createTextNode('Exposure History of Covid-19 Diagnosed cases of Sri Lanka as on 22 Mar 2020.');
    cardHeader7.appendChild(cardHeaderText7);
    const cardImageBody7 = document.createElement('div');
    cardImageBody7.setAttribute('class' , 'card-body');
    const cardImage7 = document.createElement('img');
    cardImage7.src = 'images/exposure-history-sm-v2.jpg';
    cardImageBody7.appendChild(cardImage7);

    cardImageDiv7.appendChild(cardHeader7);
    cardImageDiv7.appendChild(cardImageBody7);
    cardNum1.appendChild(cardImageDiv7);


// ----------------card Seven ended-------


appSetToImage.appendChild(cardNum1);